    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="Form" method="post" action="<?php echo base_url("admin/tutoriais/salvar_categoria") ?>">
    ...
    $(document).ready(function () {
      $(".btndeletar").click(function () {
        Swal.fire({
          ...
          if (result.value) {
            window.location = "<?php echo base_url('admin/tutoriais/deletar_categoria/') ?>" + this.getAttribute('data-id');
          }
        });
      });
    });
