        ...
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              ...
              <h2 class="mb-0">Adicionar Tutorial</h2>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <?php endif; ?>
          <form id="Form" method="post" action="<?php echo base_url("admin/salvartutorial") ?>">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group focused">
                  ...
                  <textarea id="summernote" required class="form-control" name="conteudo"></textarea>
                </div>
              </div>
            </div>
            <hr class="my-4">
