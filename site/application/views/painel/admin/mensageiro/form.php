    ...
    <div class="col-xl-12">
      <div class="card shadow">
        ...
        <div class="card-body">
          ...
          <?php endif; ?>
          <form id="Form" method="post" action="<?php echo base_url("admin/mensageiro/salvar/") . $mensagem->id ?>">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="row">
              <div class="col-8">
                <div class="form-group focused">
                  <label class="form-control-label" for="mensagem">Mensagem</label>
                  <input required maxlength="120" type="text" value="<?php echo $mensagem->mensagem; ?>" name="mensagem" id="mensagem" class="form-control form-control-alternative">
                </div>
              </div>
              <div class="col-4">
                <div class="form-group focused">
                  <label class="form-control-label" for="canal">Canal de envio (padrão - 9)</label>
                  <input type="number" min="0" max="15" required value="<?php echo$mensagem->canal; ?>" name="canal" id="canal" class="form-control form-control-alternative">
                </div>
              </div>
              <div class="col-8 offset-2 mt-3">
                <div class="form-group focused">
                  ...
                  <select id="common_options" onchange="select_common_option()" class="form-control form-control-alternative">
                    <option <?php echo ($mensagem->periodicidade == "--" ? "selected" : null) ?> value="--"> -- Configurações comuns -- </option>
                    <option <?php echo ($mensagem->periodicidade == "* * * * *" ? "selected" : null) ?> value="* * * * *">Uma vez por minuto(* * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "*/5 * * * *" ? "selected" : null) ?> value="*/5 * * * *">Uma vez a cada cinco minutos(*/5 * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "*/10 * * * *" ? "selected" : null) ?> value="*/10 * * * *">Uma vez a cada cinco minutos(*/10 * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "*/15 * * * *" ? "selected" : null) ?> value="*/15 * * * *">Uma vez a cada cinco minutos(*/15 * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0,30 * * * *" ? "selected" : null) ?> value="0,30 * * * *">Duas vezes por hora(0,30 * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 * * * *" ? "selected" : null) ?> value="0 * * * *">Uma vez por hora(0 * * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0,12 * * *" ? "selected" : null) ?> value="0 0,12 * * *">Duas vezes por dia(0 0,12 * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0 * * *" ? "selected" : null) ?> value="0 0 * * *">Uma vez por dia(0 0 * * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0 * * 0" ? "selected" : null) ?> value="0 0 * * 0">Uma vez por semana(0 0 * * 0)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0 1,15 * *" ? "selected" : null) ?> value="0 0 1,15 * *">No 1º e no 15º dia do mês(0 0 1,15 * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0 1 * *" ? "selected" : null) ?> value="0 0 1 * *">Uma vez por mês(0 0 1 * *)</option>
                    <option <?php echo ($mensagem->periodicidade == "0 0 1 1 *" ? "selected" : null) ?> value="0 0 1 1 *">Uma vez por ano(0 0 1 1 *)</option>
                  </select>
                </div>
            ...
            <a href="<?php echo base_url("admin/mensageiro") ?>" class="mr-3 btn btn-warning btn-lg float-right">Cancelar</a> 
          </form>
