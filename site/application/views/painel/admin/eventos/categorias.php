        ...
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            ...
            <div class="col text-right">
              <button class="btn btn-primary" id="botao_adicionar" data-toggle="modal"
                data-target=".bd-example-modal-lg">Nova
                Categoria</button>
            </div>
          </div>
        </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="Form" method="post" action="<?php echo base_url("admin/eventos/salvar_categoria") ?>">
    ...
    $(document).ready(function () {
      $(".btndeletar").click(function () {
        Swal.fire({
          ...
          if (result.value) {
            window.location = "<?php echo base_url('admin/eventos/deletar_categoria/') ?>" + this.getAttribute('data-id');
          }
        });
      });
    });
