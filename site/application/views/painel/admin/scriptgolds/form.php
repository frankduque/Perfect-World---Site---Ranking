        ...
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              ...
              <h2 class="mb-0">Editar script</h2>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <?php endif; ?>
          <form id="Form" method="post" action="<?php echo base_url("admin/scriptgolds/salvar/") . $script->id ?>">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
              value="<?php echo $this->security->get_csrf_hash(); ?>">
            <div class="row">
              <div class="col-8">
                <div class="form-group focused">
                  <label class="form-control-label" for="mensagem">Mensagem</label>
                  <input type="text" required value="<?php echo $script->mensagem; ?>" name="mensagem" id="mensagem"
                    class="form-control form-control-alternative">
                    <!-- placeholders -->
                    <small class="text-muted mt-2">Placeholders: <?php
              ...
              <div class="col-4">
                <div class="form-group focused">
                  <lable class="form-control-label" for="canal">Canal (padrão: 9)</label>
                    <input type="number" min="0" required value="<?php echo $script->canal; ?>" name="canal" id="canal"
                      class="form-control form-control-alternative">
                </div>
              </div>
              <div class="col-4">
                <div class="form-group focused">
                  <label class="form-control-label" for="levelminimo">Level Mínimo</label>
                  <input type="number" min="0" required value="<?php echo $script->levelminimo; ?>" name="levelminimo"
                    id="levelminimo" class="form-control form-control-alternative">
                </div>
              </div>
              <div class="col-4">
                <div class="form-group focused">
                  <label class="form-control-label" for="cultivominimo">Cultivo mínimo</label>
                  <select name="cultivominimo" class="form-control">
                    <?php foreach ($this->config->item("id2cultivo") as $key => $value): ?>
                      <option <?php echo ($script->cultivominimo == $key ? "selected" : null) ?> value="<?php echo $key ?>">
              ...
              <div class="col-4">
                <div class="form-group focused">
                  <label class="form-control-label" for="quantidade">Quantidade Golds</label>
                  <input type="quantidade" min="1" required value="<?php echo $script->quantidade; ?>" name="quantidade"
                    id="quantidade" class="form-control form-control-alternative">
                </div>
              </div>
              <div class="col-lg-3">
                <h6 class="heading-small text-muted">Precisa estar Online</h6>
              </div>
              <div class="col-lg-3 text-right mb-4">
                <label class="custom-toggle">
                  <input <?php echo ($script->estaronline == 1 ? "checked" : null) ?> type="checkbox" name="estaronline">
                  <span class="custom-toggle-slider rounded-circle"></span>
                </label>
              </div>
              <div class="col-lg-3">
                <h6 class="heading-small text-muted">Único por IP</h6>
              </div>
              <div class="col-lg-3 text-right mb-4">
                <label class="custom-toggle">
                  <input <?php echo ($script->unicoip == 1 ? "checked" : null) ?> type="checkbox" name="unicoip">
                  <span class="custom-toggle-slider rounded-circle"></span>
                </label>
              </div>
              <div class="col-lg-3">
                <h6 class="heading-small text-muted">Único por Conta</h6>
              </div>
              <div class="col-lg-3 text-right mb-4">
                <label class="custom-toggle">
                  <input <?php echo ($script->unicoconta == 1 ? "checked" : null) ?> type="checkbox" name="unicoconta">
                  <span class="custom-toggle-slider rounded-circle"></span>
                </label>
              </div>
              <div class="col-8 offset-2 mt-3">
                <div class="form-group focused">
                  ...
                  <select id="common_options" onchange="select_common_option()"
                    class="form-control form-control-alternative">
                    <option <?php echo ($script->periodicidade == "--" ? "selected" : null) ?> value="--"> --
                      Configurações comuns -- </option>
                    <option <?php echo ($script->periodicidade == "* * * * *" ? "selected" : null) ?> value="* * * * *">
                      Uma vez por minuto(* * * * *)</option>
                    <option <?php echo ($script->periodicidade == "*/5 * * * *" ? "selected" : null) ?>
                      value="*/5 * * * *">Uma vez a cada cinco minutos(*/5 * * * *)</option>
                    <option <?php echo ($script->periodicidade == "*/10 * * * *" ? "selected" : null) ?>
                      value="*/10 * * * *">Uma vez a cada cinco minutos(*/10 * * * *)</option>
                    <option <?php echo ($script->periodicidade == "*/15 * * * *" ? "selected" : null) ?>
                      value="*/15 * * * *">Uma vez a cada cinco minutos(*/15 * * * *)</option>
                    <option <?php echo ($script->periodicidade == "0,30 * * * *" ? "selected" : null) ?>
                      value="0,30 * * * *">Duas vezes por hora(0,30 * * * *)</option>
                    <option <?php echo ($script->periodicidade == "0 * * * *" ? "selected" : null) ?> value="0 * * * *">
                      Uma vez por hora(0 * * * *)</option>
                    <option <?php echo ($script->periodicidade == "0 0,12 * * *" ? "selected" : null) ?>
                      value="0 0,12 * * *">Duas vezes por dia(0 0,12 * * *)</option>
                    <option <?php echo ($script->periodicidade == "0 0 * * *" ? "selected" : null) ?> value="0 0 * * *">
                      Uma vez por dia(0 0 * * *)</option>
                    <option <?php echo ($script->periodicidade == "0 0 * * 0" ? "selected" : null) ?> value="0 0 * * 0">
                      Uma vez por semana(0 0 * * 0)</option>
                    <option <?php echo ($script->periodicidade == "0 0 1,15 * *" ? "selected" : null) ?>
                      value="0 0 1,15 * *">No 1º e no 15º dia do mês(0 0 1,15 * *)</option>
                    <option <?php echo ($script->periodicidade == "0 0 1 * *" ? "selected" : null) ?> value="0 0 1 * *">
                      Uma vez por mês(0 0 1 * *)</option>
                    <option <?php echo ($script->periodicidade == "0 0 1 1 *" ? "selected" : null) ?> value="0 0 1 1 *">
                      Uma vez por ano(0 0 1 1 *)</option>
                  </select>
                </div>
                  ...
                  <div class="col-4">
                    <div class="form-group focused">
                      ...
                      <input required type="text"
                        data-parsley-pattern="/^(\*|[1-5]?[0-9](-[1-5]?[0-9])?)(\/[1-9][0-9]*)?(,(\*|[1-5]?[0-9](-[1-5]?[0-9])?)(\/[1-9][0-9]*)?)*$/"
                        value="<?php echo $minutos; ?>" name="minutos" id="minutos"
                        class="form-control form-control-alternative">
                    </div>
                  </div>
                  <div class="col-8">
                    <div class="form-group focused">
                      ...
                      <select id="select_minutos" class="form-control form-control-alternative"
                        onchange="select_single_option('minutos')">
                        <option <?php echo ($minutos == "--" ? "selected" : null) ?> value="--">-- Configurações comuns --
                        </option>
                        <option <?php echo ($minutos == "*" ? "selected" : null) ?> value="*">Uma vez por minuto(*)
                        </option>
                        <option <?php echo ($minutos == "*/2" ? "selected" : null) ?> value="*/2">Uma vez a cada dois
                          minutos(*/2)</option>
                        <option <?php echo ($minutos == "*/5" ? "selected" : null) ?> value="*/5">Uma vez a cada cinco
                          minutos(*/5)</option>
                        <option <?php echo ($minutos == "*/10" ? "selected" : null) ?> value="*/10">Uma vez a cada dez
                          minutos(*/10)</option>
                        <option <?php echo ($minutos == "*/15" ? "selected" : null) ?> value="*/15">Uma vez a cada quinze
                          minutos(*/15)</option>
                        <option <?php echo ($minutos == "0,30" ? "selected" : null) ?> value="0,30">Uma vez a cada trinta
                          minutos(0,30)</option>
                        <option <?php echo ($minutos == "---" ? "selected" : null) ?> value="---">-- Minutos --</option>
                        <option <?php echo ($minutos == "0" ? "selected" : null) ?> value="0">:00 (Na hora cheia.) (0)
                        </option>
                        ...
                        <option <?php echo ($minutos == "15" ? "selected" : null) ?> value="15">:15 (Aos 15 minutos.) (15)
                        </option>
                        ...
                        <option <?php echo ($minutos == "30" ? "selected" : null) ?> value="30">:30 (Aos 30 minutos.) (30)
                        </option>
                        ...
                        <option <?php echo ($minutos == "45" ? "selected" : null) ?> value="45">:45 (Aos 45 minutos.) (45)
                        </option>
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group focused">
                      ...
                      <input required
                        data-parsley-pattern="/^(\*|(1?[0-9]|2[0-3])(-(1?[0-9]|2[0-3]))?)(\/[1-9][0-9]*)?(,(\*|(1?[0-9]|2[0-3])(-(1?[0-9]|2[0-3]))?)(\/[1-9][0-9]*)?)*$/"
                        type="text" value="<?php echo $horas; ?>" name="horas" id="horas"
                        class="form-control form-control-alternative">
                    </div>
                  </div>
                  <div class="col-8">
                    <div class="form-group focused">
                      <label class="form-control-label" for="canalmensagem">&nbsp;</label>
                      <select id="select_horas" class="form-control form-control-alternative"
                        onchange="select_single_option('horas')">
                        <option <?php echo ($horas == "--" ? "selected" : null) ?> value="--">-- Configurações comuns --
                        </option>
                        <option <?php echo ($horas == "*" ? "selected" : null) ?> value="*">A cada hora (*)</option>
                        <option <?php echo ($horas == "*/2" ? "selected" : null) ?> value="*/2">A cada duas horas (*/2)
                        </option>
                        <option <?php echo ($horas == "*/3" ? "selected" : null) ?> value="*/3">A cada três horas (*/3)
                        </option>
                        <option <?php echo ($horas == "*/4" ? "selected" : null) ?> value="*/4">A cada quatro horas (*/4)
                        </option>
                        <option <?php echo ($horas == "*/6" ? "selected" : null) ?> value="*/6">A cada seis horas (*/6)
                        </option>
                        <option <?php echo ($horas == "0,12" ? "selected" : null) ?> value="0,12">A cada doze horas (0,12)
                        </option>
                        <option <?php echo ($horas == "---" ? "selected" : null) ?> value="---">-- Horas --</option>
                        <option <?php echo ($horas == "0" ? "selected" : null) ?> value="0">12:00 a.m. Meia-noite (0)
                        </option>
                        ...
                        <option <?php echo ($horas == "12" ? "selected" : null) ?> value="12">12:00 p.m. Meio-dia (12)
                        </option>
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group focused">
                      ...
                      <input required type="text"
                        data-parsley-pattern="/^(\*|([1-9]|[1-2][0-9]?|3[0-1])(-([1-9]|[1-2][0-9]?|3[0-1]))?)(\/[1-9][0-9]*)?(,(\*|([1-9]|[1-2][0-9]?|3[0-1])(-([1-9]|[1-2][0-9]?|3[0-1]))?)(\/[1-9][0-9]*)?)*$/"
                        value="<?php echo $dias; ?>" name="dias" id="dias"
                        class="form-control form-control-alternative">
                    </div>
                  </div>
                  <div class="col-8">
                    <div class="form-group focused">
                      <label class="form-control-label" for="canalmensagem">&nbsp;</label>
                      <select id="select_dias" onchange="select_single_option('dias')"
                        class="form-control form-control-alternative">
                        <option <?php echo ($dias == "--" ? "selected" : null) ?> value="--"> -- Configurações comuns --
                        </option>
                        <option <?php echo ($dias == "*" ? "selected" : null) ?> value="*">A cada dia (*)</option>
                        <option <?php echo ($dias == "" ? "selected" : null) ?> value="*/2">A cada dois dias (*/2)
                        </option>
                        <option <?php echo ($dias == "1,15" ? "selected" : null) ?> value="1,15">No 1º e no 15º dia do mês
                          (1,15)</option>
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group focused">
                      ...
                      <input required type="text"
                        data-parsley-pattern="/^(\*|([1-9]|1[0-2]?)(-([1-9]|1[0-2]?))?)(\/[1-9][0-9]*)?(,(\*|([1-9]|1[0-2]?)(-([1-9]|1[0-2]?))?)(\/[1-9][0-9]*)?)*$/"
                        value="<?php echo $meses; ?>" name="meses" id="meses"
                        class="form-control form-control-alternative">
                    </div>
                  </div>
                  <div class="col-8">
                    <div class="form-group focused">
                      <label class="form-control-label" for="canalmensagem">&nbsp;</label>
                      <select id="select_meses" onchange="select_single_option('meses')"
                        class="form-control form-control-alternative">
                        <option <?php echo ($meses == "--" ? "selected" : null) ?> value="--">-- Configurações comuns --
                        </option>
                        <option <?php echo ($meses == "*" ? "selected" : null) ?> value="*">A cada mês (*)</option>
                        <option <?php echo ($meses == "*/2" ? "selected" : null) ?> value="*/2">A cada dois meses (*/2)
                        </option>
                        <option <?php echo ($meses == "*/4" ? "selected" : null) ?> value="*/4">A cada três meses (*/4)
                        </option>
                        <option <?php echo ($meses == "1,7" ? "selected" : null) ?> value="1,7">A cada seis meses (1,7)
                        </option>
                ...
                <div class="row">
                  <div class="col-4">
                    <div class="form-group focused">
                      ...
                      <input required type="text"
                        data-parsley-pattern="/^(\*|[0-6](-[0-6])?)(\/[1-9][0-9]*)?(,(\*|[0-6](-[0-6])?)(\/[1-9][0-9]*)?)*$/"
                        value="<?php echo $diassemana; ?>" name="diassemana" id="diassemana"
                        class="form-control form-control-alternative">
                    </div>
                  </div>
                  <div class="col-8">
                    <div class="form-group focused">
                      <label class="form-control-label" for="canalmensagem">&nbsp;</label>
                      <select id="select_diassemana" class="form-control form-control-alternative"
                        onchange="select_single_option('diassemana')">
                        <option <?php echo ($diassemana == "--" ? "selected" : null) ?> value="--"> -- Configurações
                          comuns -- </option>
                        <option <?php echo ($diassemana == "*" ? "selected" : null) ?> value="*">A cada dia (*)</option>
                        <option <?php echo ($diassemana == "1-5" ? "selected" : null) ?> value="1-5">A cada dia da semana
                          (1-5)</option>
                        <option <?php echo ($diassemana == "0,6" ? "selected" : null) ?> value="0,6">A cada dia do final
                          de semana (6,0)</option>
                        <option <?php echo ($diassemana == "1,3,5" ? "selected" : null) ?> value="1,3,5">A cada segunda,
                          quarta e sexta (1,3,5)</option>
                        <option <?php echo ($diassemana == "2,4" ? "selected" : null) ?> value="2,4">A cada terça e quinta
                          (2,4)</option>
                        <option <?php echo ($diassemana == "---" ? "selected" : null) ?> value="---">-- Dias da semana --
                        </option>
                        <option <?php echo ($diassemana == "0" ? "selected" : null) ?> value="0">Domingo (0)</option>
                        <option <?php echo ($diassemana == "1" ? "selected" : null) ?> value="1">Segunda-feira (1)
                        </option>
            ...
            <a href="<?php echo base_url("admin/scriptgolds"); ?>"
