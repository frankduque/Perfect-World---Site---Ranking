      ...
      <div class="card shadow">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-uppercase text-muted ls-1 mb-1">PVE</h6>
        ...
        <div class="card-body">
          ...
          <?php endif; ?>
          <form id="Form" method="post" action="<?php echo base_url("admin/pve/salvar/") . $update->id ?>">
            ...
            <a href="<?php echo base_url("admin/pve") ?>" class="mr-3 btn btn-warning btn-lg float-right">Cancelar</a> 
          </form>
        </div>
      </div>
    </div>
